...
function buildSidebar(user) {
  const adminNav = `
    ...
    <a href="fees.html"      class="nav-item"><span class="nav-icon">💰</span> Fee Management</a>
    <a href="reports.html"   class="nav-item"><span class="nav-icon">📈</span> Reports</a>`;

  const teacherNav = `
    <div class="nav-section-title">Main</div>
    <a href="dashboard.html"    class="nav-item"><span class="nav-icon">📊</span> Dashboard</a>
    <a href="courses.html"      class="nav-item"><span class="nav-icon">📚</span> My Courses</a>
    <div class="nav-section-title">Content</div>
    <a href="lessons.html"      class="nav-item"><span class="nav-icon">🎬</span> Lessons</a>
    <a href="quizzes.html"      class="nav-item"><span class="nav-icon">❓</span> Quizzes</a>
    <a href="assignments.html"  class="nav-item"><span class="nav-icon">📝</span> Assignments</a>`;

  const studentNav = `
    <div class="nav-section-title">Main</div>
    <a href="dashboard.html" class="nav-item"><span class="nav-icon">🏠</span> Dashboard</a>
    <a href="courses.html"   class="nav-item"><span class="nav-icon">📚</span> Browse Courses</a>
    <div class="nav-section-title">My Learning</div>
    <a href="my-courses.html"    class="nav-item"><span class="nav-icon">🎓</span> My Courses</a>
    <a href="assignments.html"   class="nav-item"><span class="nav-icon">📝</span> Assignments</a>
    <a href="profile.html"       class="nav-item"><span class="nav-icon">👤</span> Profile & Certs</a>`;
